...
static NSInteger const RMAppReceiptASN1TypeAppVersion = 3;
static NSInteger const RMAppReceiptASN1TypeOpaqueValue = 4;
static NSInteger const RMAppReceiptASN1TypeHash = 5;
static NSInteger const RMAppReceiptASN1TypeInAppPurchaseReceipt = 17;
static NSInteger const RMAppReceiptASN1TypeOriginalAppVersion = 19;
static NSInteger const RMAppReceiptASN1TypeExpirationDate = 21;

static NSInteger const RMAppReceiptASN1TypeQuantity = 1701;
static NSInteger const RMAppReceiptASN1TypeProductIdentifier = 1702;
static NSInteger const RMAppReceiptASN1TypeTransactionIdentifier = 1703;
static NSInteger const RMAppReceiptASN1TypePurchaseDate = 1704;
static NSInteger const RMAppReceiptASN1TypeOriginalTransactionIdentifier = 1705;
static NSInteger const RMAppReceiptASN1TypeOriginalPurchaseDate = 1706;
static NSInteger const RMAppReceiptASN1TypeSubscriptionExpirationDate = 1708;
static NSInteger const RMAppReceiptASN1TypeWebOrderLineItemID = 1711;
static NSInteger const RMAppReceiptASN1TypeCancellationDate = 1712;
...
@implementation ALSRMAppReceipt
...
- (instancetype)initWithASN1Data:(NSData*)asn1Data
{
    if (self = [super init])
    {
        ...
        [ALSRMAppReceipt enumerateASN1Attributes:(const uint8_t*)asn1Data.bytes length:asn1Data.length usingBlock:^(NSData *data, int type) {
            ...
            switch (type)
            {
                ...
                {
                    ALSRMAppReceiptIAP *purchase = [[ALSRMAppReceiptIAP alloc] initWithASN1Data:data];
                ...
                case RMAppReceiptASN1TypeExpirationDate:
                {
                    ...
                    _expirationDate = [ALSRMAppReceipt formatRFC3339String:string];
                    break;
                }
            }
        }];
...
{
    for (ALSRMAppReceiptIAP *purchase in _inAppPurchases)
    {
...
{
    ALSRMAppReceiptIAP *lastTransaction = nil;
    
    for (ALSRMAppReceiptIAP *iap in self.inAppPurchases)
    {
...
+ (ALSRMAppReceipt*)bundleReceipt
{
    ...
    */
    ...
    NSData *data = [ALSRMAppReceipt dataFromPCKS7Path:path];
    if (!data) return nil;
    
    ALSRMAppReceipt *receipt = [[ALSRMAppReceipt alloc] initWithASN1Data:data];
    return receipt;
}
...
@implementation ALSRMAppReceiptIAP
        ...
        [ALSRMAppReceipt enumerateASN1Attributes:(const uint8_t*)asn1Data.bytes length:asn1Data.length usingBlock:^(NSData *data, int type) {
            ...
            switch (type)
            {
                ...
                case RMAppReceiptASN1TypePurchaseDate:
                {
                    ...
                    _purchaseDate = [ALSRMAppReceipt formatRFC3339String:string];
                    break;
                }
                ...
                {
                    NSString *string = RMASN1ReadIA5SString(&p, length);
                    _originalPurchaseDate = [ALSRMAppReceipt formatRFC3339String:string];
                    break;
                }
                case RMAppReceiptASN1TypeSubscriptionExpirationDate:
                {
                    NSString *string = RMASN1ReadIA5SString(&p, length);
                    _subscriptionExpirationDate = [ALSRMAppReceipt formatRFC3339String:string];
                    break;
                }
                ...
                {
                    NSString *string = RMASN1ReadIA5SString(&p, length);
                    _cancellationDate = [ALSRMAppReceipt formatRFC3339String:string];
                    break;
                }
            }
        }];
