...
@interface ALSRMAppReceipt : NSObject
...
/**
 Sets the url of the Apple Root certificate that will be used to verifiy the signature of the bundle receipt. If none is provided, the resource ALSAppleIncRootCertificate.cer will be used. If no certificate is available, no signature verification will be performed.
 ...
 */
@interface ALSRMAppReceiptIAP : NSObject
